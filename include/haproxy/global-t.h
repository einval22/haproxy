...
#define	MODE_MWORKER	0x80    /* Master Worker */ // MASTER
#define	MODE_MWORKER_WAIT	0x100    /* Master Worker wait mode */ // MASTER_
...
#define	MODE_WORKER     0x20000
#define MODE_MASTER_CLI 0x40000
